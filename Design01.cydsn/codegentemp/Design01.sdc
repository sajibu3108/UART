...
# Date: Tue, 09 May 2017 23:44:56 GMT
#set_units -time ns
...
create_clock -name {reloj1(routed)} -period 200000000 -waveform {0 100000000} [list [get_pins {ClockBlock/dclk_3}]]
...
create_generated_clock -name {reloj1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 4800001 9600001} [list [get_pins {ClockBlock/dclk_glb_3}]]
