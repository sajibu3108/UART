...
*
*******************************************************************************/
void reloj1_Start(void) 
{
    /* Set the bit to enable the clock. */
    reloj1_CLKEN |= reloj1_CLKEN_MASK;
	reloj1_CLKSTBY |= reloj1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: reloj1_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    reloj1_CLKEN &= (uint8)(~reloj1_CLKEN_MASK);
	reloj1_CLKSTBY &= (uint8)(~reloj1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: reloj1_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_StopBlock(void) 
{
    if ((reloj1_CLKEN & reloj1_CLKEN_MASK) != 0u)
    {
...
#if defined(reloj1__CFG3)
        CLK_DIST_AMASK = reloj1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = reloj1_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(reloj1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(reloj1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: reloj1_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        reloj1_CLKSTBY &= (uint8)(~reloj1_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: reloj1_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = reloj1_GetSourceRegister();
    uint16 oldDivider = reloj1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = reloj1_CLKEN & reloj1_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((reloj1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: reloj1_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 reloj1_GetDividerRegister(void) 
{
    return CY_GET_REG16(reloj1_DIV_PTR);
}


/*******************************************************************************
* Function Name: reloj1_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_SetModeRegister(uint8 modeBitMask) 
{
    reloj1_MOD_SRC |= modeBitMask & (uint8)reloj1_MODE_MASK;
}


/*******************************************************************************
* Function Name: reloj1_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_ClearModeRegister(uint8 modeBitMask) 
{
    reloj1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(reloj1_MODE_MASK));
}


/*******************************************************************************
* Function Name: reloj1_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 reloj1_GetModeRegister(void) 
{
    return reloj1_MOD_SRC & (uint8)(reloj1_MODE_MASK);
}


/*******************************************************************************
* Function Name: reloj1_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = reloj1_GetDividerRegister();
    uint8 oldSrc = reloj1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        reloj1_MOD_SRC |= CYCLK_SSS;
        reloj1_MOD_SRC =
            (reloj1_MOD_SRC & (uint8)(~reloj1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: reloj1_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 reloj1_GetSourceRegister(void) 
{
    return reloj1_MOD_SRC & reloj1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: reloj1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void reloj1_SetPhaseRegister(uint8 clkPhase) 
{
    reloj1_PHASE = clkPhase & reloj1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: reloj1_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 reloj1_GetPhaseRegister(void) 
{
    return reloj1_PHASE & reloj1_PHASE_MASK;
}
